		...
		bullets: [
			html`
				...
				<ul>
					<li>
						Frontend:${' '}
						${['nodejs', 'vite', 'typescript', 'react', 'mui', 'webgl', 'threejs'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
					</li>
					<li>
						Backend:${' '}
						${['nodejs', 'typescript', 'nestjs', 'go'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
					</li>
					<li>
						Infrastructure:${' '}
						${['docker', 'terraform', 'aws'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
						<sub>(ECS/Cognito/DynamoDB/S3/CloudFront)</sub>
					</li>
					<li>
						Services:${' '}
						${['stripe', 'livekit'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
					</li>
					<li>
			...
			html`
				...
				<ul>
					<li>
						Frontend:${' '}
						${['nodejs', 'vite', 'typescript', 'react', 'mui'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
					</li>
					<li>
						Backend:${' '}
						${['python'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
						<sub>(Lambda)</sub>
					</li>
					<li>
						Infrastructure:${' '}
						${['terraform', 'aws'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
						<sub>(Lambda/Cognito/DynamoDB/S3/CloudFront)</sub>
					</li>
					<li>
						Services:${' '}
						${['stripe'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
					</li>
				</ul>
			`,
			html`
				...
				<ul>
					<li>
						${['cpp', 'directx', 'opengl', 'ffmpeg'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
					</li>
				</ul>
			`,
			html`
			...
			html`
				...
				(<a href="https://www.youtube.com/watch?v=44Ka9zlbpT8"><i class="font-icon icon-youtube1"></i></a>) and${' '}
				<a href="https://newsinitiative.withgoogle.com/dnifund/dni-projects/TelePorter/">Google Digital News Initiative Teleporter</a>${' '}
				(<a href="https://www.youtube.com/watch?v=ZX5zu1fVduo"><i class="font-icon icon-youtube1"></i></a>) projects that explored the use of XR and real-time video in live TV productions with AI-based background extraction and super resolution.
			`
		]
	},
	{
					...
					<li>
						...
						<ul>
							<li style=${{ listStyleType: 'circle' }}>
								${['typescript', 'react', 'java', 'android'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
							</li>
						</ul>
					</li>
					<li>
						...
						<ul>
							<li style=${{ listStyleType: 'circle' }}>
								${['c', 'python', 'django', 'go'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
							</li>
						</ul>
					</li>
					<li>
	...
	},
	{
		...
		bullets: [
			html`
				...
				<ul>
					<li style=${{ listStyleType: 'circle' }}>
						${['java', 'spring', 'nodejs'].map(badge => html`<img class="stack-badge" src="https://adcimon.github.io/badges/${badge}.svg" key=${badge} /> `)}
					</li>
				</ul>
			`
		]
					...
					${workHistory.map((work, idx) => html`
						<article class="timeline__item" key=${idx}>
							...
							<div class="timeline__description">
								<ul>
									${work.bullets.map((bullet, bIdx) => html`
