...
const services = [
	{
		...
		icon: 'assets/images/icons/web_development.svg',
	...
	},
	{
		...
		icon: 'assets/images/icons/artificial_intelligence.svg',
	...
	},
	{
		...
		icon: 'assets/images/icons/media_streaming.svg',
	...
	},
	{
		...
		icon: 'assets/images/icons/graphics.svg',
...
export function WhatIDo() {
	return html`
		<div class="mt-1">
			<div class="row">
				${services.map(s => html`
					<div class="col-12 col-lg-6" key=${s.title}>
						<div class="case-item">
							<img class="case-item__icon" src=${s.icon} />
							<div>
