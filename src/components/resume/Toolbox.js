...
const toolboxData = {
	...
	Programs: ['visual_studio', 'visual_studio_code', 'wireshark', 'photoshop', 'blender', 'davinci_resolve', 'obs_studio']
};
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="box box__border">
					${Object.entries(toolboxData).map(([category, badges], idx) => html`
						<div key=${category}>
