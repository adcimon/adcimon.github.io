...
const educationHistory = [
	{
		...
		period: '2022 — 2023',
		bullets: [html`<strong>Specialization:</strong> Computer Science and Electronic Systems.`],
	},
	{
	...
	},
	{
		...
		bullets: [
			html`<strong>Final Project:</strong>${' '}<a
					...
					>Development of a cross-platform game with augmented reality in Unity</a
				>.`,
			...
			html`
				...
				<div>
					Design and simulation of a robotic system made for the handling and storage of champagne bottles in
					the cellars using 3D software and SCADA systems.
				</div>
			`,
		],
	},
